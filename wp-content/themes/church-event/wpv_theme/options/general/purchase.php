...
array(
	'name' => __('Your Envato Username', 'church-event') ,
	'id' => 'envato-username',
	'type' => 'text',
	'static' => true,
) ,
...
array(
	'name' => __('Your Envato API Key', 'church-event') ,
	'desc' => sprintf(__('Do not share your API key with people you can\'t trust! Your API key gives them access to your purchased items. <a href="%s">See this page for a description of the Envato API and how to obtain an API key.</a>', 'church-event'), 'http://extras.envato.com/api/'),
	'id' => 'envato-api-key',
	'type' => 'text',
	'static' => true,
) ,
